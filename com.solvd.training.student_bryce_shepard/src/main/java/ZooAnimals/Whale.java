...
public abstract class Whale extends Animal implements ISwimmer {
    ...
    @Override
    public void breach(){
        System.out.printf("%s majestically breaches, soaring into the air before splashing down.%n", this.name);
    }

    @Override
    public void swim(){
        System.out.printf("See %s gracefully charge through the water.%n", this.name);
    }
